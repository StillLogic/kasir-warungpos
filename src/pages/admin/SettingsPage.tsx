      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Konfigurasi pajak untuk transaksi</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Tambahkan pajak ke setiap transaksi
                </p>
              </div>
              <Switch
                id="taxEnabled"
      ...
      <div className="lg:sticky lg:top-4 lg:self-start space-y-4">
        <Card>
          <CardHeader className="pb-3">
            ...
            <CardDescription>Tampilan struk sesuai pengaturan</CardDescription>
          </CardHeader>
          <CardContent>
