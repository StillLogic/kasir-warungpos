...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Konfirmasi Email Anda',
  invite: 'Anda Diundang',
  magiclink: 'Link Masuk Anda',
  recovery: 'Reset Password',
  email_change: 'Konfirmasi Perubahan Email',
  reauthentication: 'Kode Verifikasi Anda',
}
...
// Configuration
const SITE_NAME = "kasir-warungpos"
const SENDER_DOMAIN = "notify.warungpos.stilllogic.my.id"
const ROOT_DOMAIN = "warungpos.stilllogic.my.id"
const FROM_DOMAIN = "warungpos.stilllogic.my.id" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://kasir-warungpos.lovable.app"
